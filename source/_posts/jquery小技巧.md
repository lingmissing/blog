...
注: 在版本 jQuery 1.4 中，$.support 替换掉了$.browser 变量
...
如果使用了两个 CSS 列，使用此种方式可以是两列的高度相同。
...
注：直接使用 CSS 实现该效果可能是更好的解决方案，但你仍然有必要知道该方法。
...
$(document).ready(function() {
  var el = $('#id')
  el.html(el.html().replace(/word/gi, ''))
})
```
...
当改变 Window 大小时，在 ID 与 Class 之间切换
...
> 原文地址：[人人都会的 35 个 Jquery 小技巧](http://segmentfault.com/a/1190000003902322)
